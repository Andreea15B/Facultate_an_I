...
public:
 ...
 void Set(const char *text); // copiaza in sir pe text. Daca e nevoie, redimensioneaza pe sir
 ...
 // returneaza un obiect nou MyString in care copiaza din obiectul curent sub-sirul care incepe de la pozitia start si are lungimea size.
